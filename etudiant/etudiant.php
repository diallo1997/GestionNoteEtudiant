...
<body>
    ...
    <section class="Maquette" id="Maquette">

        <h1 class="heading"><span>Maquette</span> </h1>
    ...
    <section class="Reclammation" id="Reclammation">

        <h1 class="heading"><span>Reclammation</span> </h1>

        </div>

    </section>

    <section class="Parametres" id="Parametres">

        <h1 class="heading"><span>Parametres</span> </h1>
