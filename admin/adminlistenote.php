        ...
        <div class="home-content">
            <div class="container">
                ...
                <table>
                    ...
                    $requete->execute();
                    echo "
                        <table border='2' style='color: blue; width:100%''>
                        <caption>La Liste Des note</caption>
                        <tr><td>NumCarte</td><td>Note</td><td>Niveau</td></tr>
                    ";
                    while ($File = $requete->fetch(PDO::FETCH_OBJ)) {
                        ...
                        echo "<tr><td>$login</td><td>$mdp</td><td>$statut</td></tr>";
                    }
